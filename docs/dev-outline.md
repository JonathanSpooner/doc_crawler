...
│   │   ├── alerts_repository.py [complete]
│   │   ├── author_works_repository.py
│   │   ├── content_changes_repository.py [complete]
│   │   ├── content_index_repository.py
│   │   ├── crawl_sessions_repository.py [complete]
│   │   ├── pages_repository.py [complete]
│   │   ├── processing_queue_repository.py [complete]
│   │   ├── site_maps_repository.py [complete]
│   │   └── sites_repository.py [complete]
│   └── migrations/
├── processors/
│   ├── text_cleaner.py
│   ├── pdf_converter.py
...
Implement the `author_works_repository.py`